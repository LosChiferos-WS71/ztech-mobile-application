...
class AddPotInvalidCodeScreen extends StatefulWidget {
  @override
  _AddPotInvalidCodeScreenState createState() => _AddPotInvalidCodeScreenState();
}

class _AddPotInvalidCodeScreenState extends State<AddPotInvalidCodeScreen> {
